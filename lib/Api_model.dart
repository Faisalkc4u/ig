...
class IGAPIModel {
  ...
  Future<bool> getUserData() async {
    ...
    try {
      ...
      'https://instagram.com/graphql/query/?query_id=17888483320059182&variables={"id":"'+this.user.id+'","first":2327,"after":null}',
    );
        this.ob=Autogenerated.fromJson(  jsonDecode(respo.body));
